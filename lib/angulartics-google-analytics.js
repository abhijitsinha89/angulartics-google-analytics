(function(window, angular, undefined) {
    ...
    .config(['$analyticsProvider', 'DeviceTypeProvider', function($analyticsProvider, DeviceTypeProvider) {
        ...
        $analyticsProvider.registerEventTrack(function(action, properties) {
            ...
            if (properties.category) {
                properties.category = DeviceTypeProvider.detect() + '-' + properties.category;
            }
